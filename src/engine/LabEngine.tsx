        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center">
              <Router className="text-emerald-400" size={24} />
            </div>
            <div>
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-semibold text-lg transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="bg-slate-800 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-emerald-400">Career Insight</h2>
            </div>
