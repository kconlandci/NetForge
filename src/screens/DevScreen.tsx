// ============================================================
// NetForge Dev Preview Screen — /dev
// ============================================================
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 pb-24">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-lg font-bold text-white">NetForge Dev Preview</h1>
          ...
          {labCatalog.map((lab) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <Link
                  to={`/lab/${lab.id}`}
                  className="shrink-0 px-3 py-1.5 rounded bg-emerald-500 text-white text-xs font-semibold hover:bg-emerald-600 transition-colors"
                >
                  Play
                </Link>
              </div>
